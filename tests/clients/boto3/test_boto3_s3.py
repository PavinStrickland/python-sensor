...
class TestS3(unittest.TestCase):
    ...
    def test_s3_create_bucket(self):
        ...
        self.assertDictEqual(
            boto_span.data["boto3"]["payload"], {"Bucket": "aws_bucket_name"}
        )
    ...
    def test_s3_upload_file_obj(self):
        ...
        self.assertEqual(boto_span.data["http"]["method"], "POST")
        self.assertEqual(
            boto_span.data["http"]["url"], "https://s3.amazonaws.com:443/upload_fileobj"
        )
    ...
    def test_s3_download_file(self):
        ...
        self.assertEqual(boto_span.data["http"]["method"], "POST")
        self.assertEqual(
            boto_span.data["http"]["url"], "https://s3.amazonaws.com:443/download_file"
        )
