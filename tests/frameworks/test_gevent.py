...
import urllib3
from gevent.pool import Group  # type: ignore
from instana.singletons import tracer
from instana.span import SDKSpan
from opentracing.scope_managers.gevent import GeventScopeManager  # type: ignore

from ..helpers import get_spans_by_filter, testenv
...
class TestGEvent(unittest.TestCase):
    def setUp(self):
        self.http = urllib3.HTTPConnectionPool(
            "127.0.0.1", port=testenv["wsgi_port"], maxsize=20
        )
