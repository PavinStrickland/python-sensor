...
def boot_agent():
    ...
    if "INSTANA_DISABLE_AUTO_INSTR" not in os.environ:
        ...
        from .instrumentation.aiohttp import client, server
        from .instrumentation.aws import lambda_inst  # noqa: F401
        from .instrumentation.celery import hooks  # noqa: F401
        from .instrumentation.django import middleware  # noqa: F401
        from .instrumentation.google.cloud import pubsub, storage  # noqa: F401
        from .instrumentation.tornado import client, server  # noqa: F401, F811

    # Hooks
    from .hooks import hook_uwsgi  # noqa: F401
