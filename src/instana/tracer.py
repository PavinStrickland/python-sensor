...
from .recorder import InstanaSampler, StanRecorder
...
class InstanaTracer(BasicTracer):
    def __init__(self, scope_manager=None, recorder=None):
        ...
        super(InstanaTracer, self).__init__(recorder, InstanaSampler(), scope_manager)
    ...
    def start_span(
        ...
        if child_of is not None:
            parent_ctx = (
                child_of if isinstance(child_of, SpanContext) else child_of.context
            )
